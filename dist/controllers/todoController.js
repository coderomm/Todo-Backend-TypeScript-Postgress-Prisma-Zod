...
var createTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, description, userId, todo, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = todoSchema.parse(req.body), title = _a.title, description = _a.description;
...
var getTodos = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, todos, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userId = req.user.userId;
                return [4 /*yield*/, prisma.todo.findMany({ where: { userId: userId } })];
            case 1:
                todos = _a.sent();
                res.json(todos);
                return [3 /*break*/, 3];
